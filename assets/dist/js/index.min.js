...
$(".carousel").slick({infinite:!0,slidesToShow:4,slidesToScroll:4,responsive:[{breakpoint:1350,settings:{arrows:!1}},{breakpoint:1024,settings:{slidesToShow:2,slidesToScroll:2,infinite:!0,arrows:!1}},{breakpoint:768,settings:{slidesToShow:2,slidesToScroll:2,arrows:!1}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1,arrows:!1}}]});const btnNext=document.getElementById("btn-left"),btnPrev=document.getElementById("btn-right"),nextBtnSlick=document.querySelector(".slick-next"),prevBtnSlick=document.querySelector(".slick-prev"),button=(btnNext&btnPrev&btnPrev&prevBtnSlick&&(btnNext.addEventListener("click",()=>{prevBtnSlick.click()}),btnPrev.addEventListener("click",()=>{nextBtnSlick.click()})),document.querySelector(".menu_burger")),menuActive=document.querySelector(".menu");button.addEventListener("click",()=>{button.classList.toggle("active"),menuActive.classList.toggle("menu_active"),document.body.classList.toggle("body-active")});let url=window.location.pathname;("/modal.html"===url?(startAni(),modalAni):(startAni(),slickAni))();const bgMasActive=document.querySelector(".burger-messager"),idclos=document.querySelector(".closed"),mesBG=document.querySelector(".bg-position"),tl_bg=gsap.timeline(),earPohne=(bgMasActive.addEventListener("click",()=>{tl_bg.from(mesBG,{opacity:0,x:-40}),mesBG.classList.add("bg-pos-active"),mesBG.classList.add("bg-pos-oppacity")}),idclos.addEventListener("click",()=>{let e=tl_bg.to(mesBG,{x:0,opacity:0});mesBG.classList.remove("bg-pos-oppacity"),setTimeout(()=>{mesBG.classList.remove("bg-pos-active")},500),e.repeat()}),document.querySelectorAll(".container__img-ear")),imgEar=document.querySelectorAll(".img-ear"),mask=(earPohne.forEach(e=>{e.addEventListener("mouseover",function(){this.firstChild.classList.add("img-ear-active")}),e.addEventListener("mouseout",function(){this.firstChild.classList.remove("img-ear-active")})}),document.querySelector(".mask-animation")),links=[...document.getElementsByTagName("a")];links.forEach(e=>{e.addEventListener("click",e=>{e.preventDefault(),mask.classList.add("mask-animation-active"),setTimeout(()=>{location.href=e.target.href},900)})});
function startAni(){const t=gsap.timeline({defaults:{duration:.5}});t.from("li",{opacity:0,x:"100%",duration:.7},"<").from("h1",{opacity:0,x:"100%",duration:.7},"<").from(".head_menu",{opacity:0,y:-40})}function slickAni(){gsap.from(".content__item",{duration:.5,scale:.5,opacity:0,stagger:.2,force3D:!0});const t=gsap.timeline({defaults:{duration:.5}});t.from(".slick-prev",{x:-100,opacity:0,duration:.5},"<").from(".slick-next",{x:100,opacity:0,duration:.5},"<")}function modalAni(){const t=gsap.timeline({defaults:{duration:1}});t.from(".modal__item",{x:"-100%",opacity:0,duration:.5}).from(".content__item-text",{y:"100%",opacity:0,duration:.7}).from(".content__item-text p",{x:"100%",opacity:0,duration:.5}).from(".slider-prev",{x:-100,opacity:0,duration:.5}).from(".slider-next",{x:100,opacity:0,duration:.5},"<")}