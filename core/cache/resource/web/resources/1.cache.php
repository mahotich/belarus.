<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1662147652,
    'editedby' => 1,
    'editedon' => 1662722799,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1662566340,
    'publishedby' => 0,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<header>
  <div class="container">
    ...
    <nav class="menu">
    <ul class=""><li class="menu__items menu__active"><a href="/" >Памятники ВОВ</a></li><li class="menu__items"><a href="castle" >Замки</a></li><li class="menu__items"><a href="parki-i-zapovedniki" >Парки и заповедники</a></li><li class="menu__items"><a href="dvorczyi" >Дворцы</a></li><li class="menu__items"><a href="uliczyi" >Улицы</a></li></ul>
    </nav>
  </div>
</header>
   <main data-barba="container">
    ...
    <div class="container__img-ear container__img-ear-active">
        <img data-sound="assets/dist/music/boi.mp3" class="img-ear" src="./assets/dist/img/svg/earphones.svg" alt="">
        <img data-sound="assets/dist/music/boi.mp3" class="content__item-img"  src="assets/dist/img/vov/byiniskoe_pole.png"  alt="Буйничское поле">
    </div>
    <p class="content__item_text">Буйничское поле</p>
    <p class="content__item_subtext">
        <a href="bujnichskoe-pole">Подробнее &rarr;</a>
    </p>
</div>
<div class="content__item ">
    <div class="container__img-ear container__img-ear-active">
        <img data-sound="assets/dist/music/ogn.mp3" class="img-ear" src="./assets/dist/img/svg/earphones.svg" alt="">
        <img data-sound="assets/dist/music/ogn.mp3" class="content__item-img"  src="assets/dist/img/vov/daliva.png"  alt="Дальва">
    </div>
    <p class="content__item_text">Дальва</p>
    <p class="content__item_subtext">
        <a href="dalva">Подробнее &rarr;</a>
    </p>
</div>
<div class="content__item ">
    <div class="container__img-ear container__img-ear-active">
        <img data-sound="assets/dist/music/boi.mp3" class="img-ear" src="./assets/dist/img/svg/earphones.svg" alt="">
        <img data-sound="assets/dist/music/boi.mp3" class="content__item-img"  src="assets/dist/img/vov/linia_stalina.png"  alt="Линия Сталина">
    </div>
    <p class="content__item_text">Линия Сталина</p>
    <p class="content__item_subtext">
        <a href="liniya-stalina">Подробнее &rarr;</a>
    </p>
</div>
<div class="content__item ">
    <div class="container__img-ear container__img-ear-active">
        <img data-sound="assets/dist/music/ogn.mp3" class="img-ear" src="./assets/dist/img/svg/earphones.svg" alt="">
        <img data-sound="assets/dist/music/ogn.mp3" class="content__item-img"  src="assets/dist/img/vov/hatin.png"  alt="Хатынь">
    </div>
    <p class="content__item_text">Хатынь</p>
    <p class="content__item_subtext">
        <a href="xatyin">Подробнее &rarr;</a>
    </p>
</div>
<div class="content__item ">
    <div class="container__img-ear container__img-ear-active">
        <img data-sound="assets/dist/music/boi.mp3" class="img-ear" src="./assets/dist/img/svg/earphones.svg" alt="">
        <img data-sound="assets/dist/music/boi.mp3" class="content__item-img"  src="assets/dist/img/vov/kyrgan_slavi.png"  alt="Курган Славы">
    </div>
    <p class="content__item_text">Курган Славы</p>
    <p class="content__item_subtext">
        <a href="kurgan-slavyi">Подробнее &rarr;</a>
    </p>
</div>
<div class="content__item ">
    <div class="container__img-ear container__img-ear-active">
        <img data-sound="assets/dist/music/boi.mp3" class="img-ear" src="./assets/dist/img/svg/earphones.svg" alt="">
        <img data-sound="assets/dist/music/boi.mp3" class="content__item-img"  src="assets/dist/img/vov/minsk_gg.png"  alt="Стела «Минск – город-герой»">
    </div>
    <p class="content__item_text">Стела «Минск – город-герой»</p>
    <p class="content__item_subtext">
        <a href="stela-«minsk-–-gorod-geroj»">Подробнее &rarr;</a>
    </p>
</div>
<div class="content__item ">
    <div class="container__img-ear container__img-ear-active">
        <img data-sound="assets/dist/music/boi.mp3" class="img-ear" src="./assets/dist/img/svg/earphones.svg" alt="">
        <img data-sound="assets/dist/music/boi.mp3" class="content__item-img"  src="assets/dist/img/vov/brest_kr.jpg"  alt="Брестская крепость-герой">
    </div>
    <p class="content__item_text">Брестская крепость-герой</p>
    <p class="content__item_subtext">
        <a href="brestskaya-krepost-geroj">Подробнее &rarr;</a>
    </p>
</div>
<div class="content__item ">
    <div class="container__img-ear container__img-ear-active">
        <img data-sound="assets/dist/music/boi.mp3" class="img-ear" src="./assets/dist/img/svg/earphones.svg" alt="">
        <img data-sound="assets/dist/music/boi.mp3" class="content__item-img"  src="assets/dist/img/vov/monyment_pobedi.jpg"  alt="Монумент Победы">
    </div>
    <p class="content__item_text">Монумент Победы</p>
    <p class="content__item_subtext">
        <a href="monument-pobedyi">Подробнее &rarr;</a>
    </p>
</div>
    ...
    &rowClass = `menu__items`]]
      ...
      array (
        ...
        array (
          ...
          'property_preprocess' => false,
          'name' => 'songPlay',
          'description' => 'Для воспроизведения звуков',
          'editor_type' => 0,
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '<script>
