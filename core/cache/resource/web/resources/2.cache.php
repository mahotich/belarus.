...
<header>
  <div class="container">
    <div class="head_menu">
      <div class="logo">
        <a href="http://belarus/"><img src="./assets/dist/img/svg/Belarus.svg" alt="Belarus."></a>
      </div>
    ...
    <nav class="menu">
      <ul>
        <li class="menu__items menu__active"><a href="/">Памятники ВОВ</a></li>
        <li class="menu__items"><a href="castle">Замки</a></li>
        <li class="menu__items"><a href="parki-i-zapovedniki">Парки и заповедники</a></li>
        <li class="menu__items"><a href="./palaces.html">Дворцы</a></li>
        <li class="menu__items"><a href="./street.html">Улицы</a></li>
      </ul>
    </nav>
  </div>
</header>
          ...
          <div class="slider-container">
            <div class="carousel">
              ...
              <p class="content__item_subtext">
                <a href="./modal.html">Подробнее &rarr;</a>
              </p>
            </div>
<div class=" content__item slider">
              <div class="text-activ">
...
<header>
  <div class="container">
    <div class="head_menu">
      <div class="logo">
        <a href="[[~1]]"><img src="./assets/dist/img/svg/Belarus.svg" alt="Belarus."></a>
      </div>
      <div class="head_menu__message">
        <div class="bg-position">
          <div class="bg-masseger">
    ...
    <nav class="menu">
      <ul>
        <li class="menu__items menu__active"><a href="/">Памятники ВОВ</a></li>
        <li class="menu__items"><a href="[[~2]]">Замки</a></li>
        <li class="menu__items"><a href="[[~22]]">Парки и заповедники</a></li>
        <li class="menu__items"><a href="./palaces.html">Дворцы</a></li>
        <li class="menu__items"><a href="./street.html">Улицы</a></li>
      </ul>
    </nav>
