<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1662316253,
    'editedby' => 1,
    'editedon' => 1662583736,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1662316260,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<header>
  <div class="container">
    ...
    <nav class="menu">
    <ul class=""><li class="menu__items"><a href="/" >Памятники ВОВ</a></li><li class="menu__items menu__active"><a href="castle" >Замки</a></li><li class="menu__items"><a href="parki-i-zapovedniki" >Парки и заповедники</a></li><li class="menu__items"><a href="dvorczyi" >Дворцы</a></li><li class="menu__items"><a href="uliczyi" >Улицы</a></li></ul>
    </nav>
  </div>
</header>
          ...
          <div class="slider-container">
            <div class="carousel">
              ...
              <div class="text-activ">
                <span class="descr">
                 Призрак дамы с собачкой - говорят, что жила когда-то в Крево красавица неземная. И так она понравилась двум князьям из замка, что устроили они дуэль между собой. Победитель должен был жениться на девушке. Но своенравная красавица отказалась от предложения. Разгневанный победитель проклял ее и приказал слугам замуровать красавицу вместе с ее любимой собачкой. И вот с тех пор по ночам призрак девушки выходит выгуливать свою собачку.
                </span>
                <div class=ImgField>
                  <img class="content__item-img image first" src="assets/dist/img/castle/crevski.png" alt="Кревский замок" >
                  <img class="content__item-img image second" src="assets/dist/img/castle/crevski_2.png" alt="Кревский замок" >
                </div>
              </div>
              <p class="content__item_text">Кревский замок</p>
              <p class="content__item_subtext">
                <a href="krevskij-zamok">Подробнее &rarr;</a>
              </p>
            </div>
<div class=" content__item slider">
              <div class="text-activ">
                <span class="descr">
                 Самое удивительное в истории замка то, что ни у нас, ни в Литве, ни в Польше не найдено ни одного плана-схемы и инвентаря из замка. Как в целом выглядел замок, что было в каждой башне, никто не знает. Археологам известно, что под землей есть развалины княжеского дворца и фундамент храма Успения пресвятой Богородицы, но и их описания тоже нет.
                </span>
                <div class=ImgField>
                  <img class="content__item-img image first" src="assets/dist/img/castle/novogrydski.png" alt="Новогрудский замок" >
                  <img class="content__item-img image second" src="assets/dist/img/castle/novogrydski_2.png" alt="Новогрудский замок" >
                </div>
              </div>
              <p class="content__item_text">Новогрудский замок</p>
              <p class="content__item_subtext">
                <a href="novogrudskij-zamok">Подробнее &rarr;</a>
              </p>
            </div>
<div class=" content__item slider">
              <div class="text-activ">
                <span class="descr">
                 Ходят легенды, что ещё во времена Витовта в одном из этих подземелий существовал тайный ход, ведущий от замковых стен к Нёману. С помощью него можно было в считанные минуты оказаться на другом берегу реки. Об этом свидетельствуют раскопки знаменитого археолога Михаила Ткачёва – по его словам, он воочию видел этот старинный заваленный камнями лаз.
                </span>
                <div class=ImgField>
                  <img class="content__item-img image first" src="assets/dist/img/castle/grod.png" alt="Гродненский замок" >
                  <img class="content__item-img image second" src="assets/dist/img/castle/grod_2.png" alt="Гродненский замок" >
                </div>
              </div>
              <p class="content__item_text">Гродненский замок</p>
              <p class="content__item_subtext">
                <a href="grodnenskij-zamok">Подробнее &rarr;</a>
              </p>
            </div>
<div class=" content__item slider">
              <div class="text-activ">
                <span class="descr">
                 Черная Дама - призрак графини Ядвиги, который живет в замке; по легенде графиня очень любила кататься на санях, и каталась даже летом, для этого приходилось делать гору из соли, за что прокленали графиню конюхи (которые лечили лошадей из-за соли) и садовники; В результате проклятие сработало
                </span>
                <div class=ImgField>
                  <img class="content__item-img image first" src="assets/dist/img/castle/kosov.png" alt="Коссовский замок" >
                  <img class="content__item-img image second" src="assets/dist/img/castle/kosov_2.png" alt="Коссовский замок" >
                </div>
              </div>
              <p class="content__item_text">Коссовский замок</p>
              <p class="content__item_subtext">
                <a href="kossovskij-zamok">Подробнее &rarr;</a>
              </p>
            </div>
<div class=" content__item slider">
              <div class="text-activ">
                <span class="descr">
                 Призрачные дружинники - по легенде в 1392 г. происходила осада крестоносцев, и хотя у местного князя Дмитрий Корибута было достаточно войск, он предпочел сбежать из замка подземным ходом, оставив часть дружины “прикрывать отступление”. Оставшиеся “смертники”, по сути, преданные своим князем, мужественно сражались и погибли все до одного… С тех пор по ночам в Лидском замке слышен звон оружия и шаги призрачных дружинников, которые защищают твердыню и после смерти. 
                </span>
                <div class=ImgField>
                  <img class="content__item-img image first" src="assets/dist/img/castle/lidski.png" alt="Лидский замок" >
                  <img class="content__item-img image second" src="assets/dist/img/castle/lidski_2.png" alt="Лидский замок" >
                </div>
              </div>
              <p class="content__item_text">Лидский замок</p>
              <p class="content__item_subtext">
                <a href="lidskij-zamok">Подробнее &rarr;</a>
              </p>
            </div>
<div class=" content__item slider">
              <div class="text-activ">
                <span class="descr">
                 Призрак Белая Пани - легенда гласит, что князь Николай Святополк-Мирский приказал выкопать пруд, а для этого срубить цветущий яблоневый сад. В результате, в пруду поселились русалки и каждый год в нем стали тонуть люди. И первой погибла дочь Николая, 12-летняя Сонечка… Именно она теперь бродит по замку под именем Белая Пани.
                </span>
                <div class=ImgField>
                  <img class="content__item-img image first" src="assets/dist/img/castle/mirski.jpg" alt="Мирский замок" >
                  <img class="content__item-img image second" src="assets/dist/img/castle/mirski_2.png" alt="Мирский замок" >
                </div>
              </div>
              <p class="content__item_text">Мирский замок</p>
              <p class="content__item_subtext">
                <a href="mirskij-zamok">Подробнее &rarr;</a>
              </p>
            </div>
<div class=" content__item slider">
              <div class="text-activ">
                <span class="descr">
                 В XVII веке князьями Радзивиллами в Сморгони была основана Медвежья академия, где дрессировали медведей цыгане. Богуслав Радзивилл, владелец Любчанского замка, решил переплюнуть своих Несвижских родственников и привез к себе в замок панду. Панда жила в башне и вечно мёрзла, отчего постоянно ютилась возле камина и со временем от пепла и копоти стала серого цвета, а после и вовсе сошла с ума. Чтобы избежать беды, панду пришлось убить. Закопали бедное животное в парке возле замка. ​С тех пор призрак замученной обезумевшей панды бродит в ночи по окрестностям Любчанского замка и своим раскатистым рыком пугает людей.​‌‌​‌‌​ ​‌​‌‌‌‌ ​​​‌​‌ ​​‌‌​​ ​​‌​​​ ​‌​​​‌ ​​‌‌​‌ ​​
                </span>
                <div class=ImgField>
                  <img class="content__item-img image first" src="assets/dist/img/castle/lybchinski.png" alt="Любчанский замок" >
                  <img class="content__item-img image second" src="assets/dist/img/castle/lybchenski_2.png" alt="Любчанский замок" >
                </div>
              </div>
              <p class="content__item_text">Любчанский замок</p>
              <p class="content__item_subtext">
                <a href="lyubchanskij-zamok">Подробнее &rarr;</a>
              </p>
            </div>
<div class=" content__item slider">
              <div class="text-activ">
                ...
                <div class=ImgField>
                  <img class="content__item-img image first" src="assets/dist/img/castle/nesveski.jpg" alt="Несвижский замок" >
                  <img class="content__item-img image second" src="src/img/castle/nesvecki_2.png" alt="Несвижский замок" >
                </div>
              </div>
              <p class="content__item_text">Несвижский замок</p>
              <p class="content__item_subtext">
                <a href="nesvizhskij-zamok">Подробнее &rarr;</a>
              </p>
            </div>
  ...
  array (
    ...
    &rowClass = `menu__items`]]' => '<ul class=""><li class="menu__items"><a href="/" >Памятники ВОВ</a></li><li class="menu__items menu__active"><a href="castle" >Замки</a></li><li class="menu__items"><a href="parki-i-zapovedniki" >Парки и заповедники</a></li><li class="menu__items"><a href="dvorczyi" >Дворцы</a></li><li class="menu__items"><a href="uliczyi" >Улицы</a></li></ul>',
    '[[$HEAD]]' => '<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
<div class=" content__item slider">
    ...
    '[[$FOOTER]]' => '    <script src="./assets/dist/js/index.min.js"></script>
  ...
  <div class="container">
    ...
    &rowClass = `menu__items`]]
      ...
      array (
        ...
        array (
          ...
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '    <script src="./assets/dist/js/index.min.js"></script>
    ...
    idclos.addEventListener(\'click\',()=>{
      ...
      qw.repeat()
          ...
          'static' => false,
          'static_file' => '',
          'content' => '    <script src="./assets/dist/js/index.min.js"></script>
